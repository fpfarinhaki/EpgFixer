...
channel_id_dic = {
    ...
    "ID": ['INVESTIGATION DISCOVERY FHD', 'INVESTIGAÇÃO DISCOVERY', 'INVESTIGAÇÃO DISCOVERY HD',
    ...
    "National Geographic": ['NAT GEO FHD', 'NAT GEO HD', 'NAT GEO SD', 'NatGeo HD [Alter]', 'NatGeo [Alter]'],
    ...
    "TV Rá Tim Bum": ['TV RA TIM BUM FHD', 'TV RA TIM BUM HD', 'TV RA TIM BUM SD', 'TV RA TIM BUM [Alter]'],
    ...
    "The History Channel": ['HISTORY SD', 'History [Alter]', 'HISTORY FHD', 'HISTORY HD', 'History HD [Alter]'],
    ...
    "Universal TV": ['UNIVERSAL CHANNEL FHD', 'UNIVERSAL CHANNEL HD', 'UNIVERSAL CHANNEL SD',
