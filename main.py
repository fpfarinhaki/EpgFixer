...
channel_id_dic = {
    ...
    "Gloob": ['GLOOB FHD', 'GLOOB HD', 'GLOOB SD', 'GLOOBINHO FHD', 'GLOOBINHO HD', 'GLOOBINHO SD',
              'Gloob HD [Alter]', 'Gloob [Alter]'],
    ...
    "MTV": ['MTV', 'MTV FHD', 'MTV HD', 'MTV HD [Alter]', 'MTV LIVE FHD', 'MTV LIVE HD', 'MTV LIVE SD', 'MTV [Alter]'],
    ...
    "VH1": ['VH1 FHD', 'VH1 HD', 'VH1 HD [Alter]', 'VH1 MEGA HITS SD', 'VH1 Mega Hits [Alter]', 'VH1 SD'],
