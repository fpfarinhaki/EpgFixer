...
class M3uChannelCollector(M3uCollector):
    channel_id_dic = {
        ...
        "Discovery Turbo": ['DISCOVERY TURBO', 'DISCOVERY TURBO FHD', 'DISCOVERY TURBO HD',
                            'Discovery Turbo HD [Alter]',
        ...
        "ESPN Brasil": ['ESPN BRASIL FHD', 'ESPN BRASIL HD', 'ESPN BRASIL HD [Alter]', 'ESPN BRASIL SD',
                        'Espn Brasil [Alter]'],
        "ESPN Extra": ['ESPN EXTRA HD', 'ESPN EXTRA SD', 'ESPN Extra FHD', 'ESPN Extra HD [Alter]',
                       'ESPN Plus HD [Alter]'],
        ...
        "Fox Sports": ['FOX SPORTS FHD', 'FOX SPORTS HD', 'FOX SPORTS HD [Alter]', 'FOX SPORTS SD',
                       'FOX SPORTS [Alter]'],
        ...
        "HBO Family": ['HBO FAMILY FHD', 'HBO FAMILY HD', 'HBO FAMILY SD', 'HBO Family HD [Alter]',
                       'HBO Family [Alter]'],
        ...
        "Premiere Clubes": ['PREMIERE CLUBES FHD', 'Premiere Clubes HD', 'Premiere Clubes HD [Alter]',
                            'Premiere Clubes SD',
                            'Premiere Clubes [Alter]'],
        "Premiere 2": ['PREMIERE 2 FHD', 'PREMIERE 2 HD', 'PREMIERE 2 SD', 'Premiere 2 HD [Alter]',
                       'Premiere 2 [Alter]'],
        "Premiere 3": ['PREMIERE 3 FHD', 'PREMIERE 3 HD', 'PREMIERE 3 SD', 'Premiere 3 HD [Alter]',
                       'Premiere 3 [Alter]'],
        "Premiere 4": ['PREMIERE 4 FHD', 'PREMIERE 4 HD', 'PREMIERE 4 SD', 'Premiere 4 HD [Alter]',
                       'Premiere 4 [Alter]'],
        "Premiere 5": ['PREMIERE 5 FHD', 'PREMIERE 5 HD', 'PREMIERE 5 SD', 'Premiere 5 HD [Alter]',
                       'Premiere 5 [Alter]'],
        "Premiere 6": ['PREMIERE 6 FHD', 'PREMIERE 6 HD', 'PREMIERE 6 SD', 'Premiere 6 HD [Alter]',
                       'Premiere 6 [Alter]'],
        "Premiere 7": ['PREMIERE 7 FHD', 'PREMIERE 7 HD', 'PREMIERE 7 SD', 'Premiere 7 HD [Alter]',
                       'Premiere 7 [Alter]'],
        ...
        "TNT SERIES": ['TNT SERIES FHD', 'TNT SERIES HD', 'TNT SERIES SD', 'TNT Series HD [Alter]',
                       'TNT Series [Alter]'],
        ...
        "Warner": ['WARNER CHANNEL HD', 'WARNER CHANNEL SD', 'WARNER FHD', 'Warner Channel [Alter]',
                   'Warner HD [Alter]'],
